...
* Unweighted Means 
collapse (mean) male female age_22_34 age_35_49 age_50_64 age_65_plus college no_college full_time managers professionals technicians clerical service_sales craft plant elementary goods service essential non_essential Teleworkable non_tele part_time one_med_cond one_func_limit num_limit
...
* Weighted Means 
collapse (mean) male female age_22_34 age_35_49 age_50_64 age_65_plus college no_college full_time managers professionals technicians clerical service_sales craft plant elementary goods service essential non_essential Teleworkable non_tele part_time one_med_cond one_func_limit num_limit [aw=weight]
...
* Steps:
* Use uncollapsed datasets for HFCS and CPS, then collapse to find the mean, sd, and n of each variable
* Merge those datasets together in a wide format so there is only one row that has the means, sd, n's for HFCS (group 1) and CPS (group 2)
* Run a loop that displays ttesti for each variable, using the 6 stats present in the wide data
...
tempname starsfile
postfile `starsfile' str20 varname str5 stars using "Code\paper1_AR\ttest_results_with_stars.dta", replace
...
use "Code\paper1_AR\ttest_results_with_stars.dta", clear
